...
namespace Rivet {
  ...
  public:
	...
	_h_AbsPtclDiffXsecTjPt->fill( noBtag.pT(),     event.weight() ); //(5,1,1);
	_h_AbsPtclDiffXsecTjY->fill(  noBtag.absrap(), event.weight() ); //(5,1,3);
	_h_NrmPtclDiffXsecTjPt->fill( noBtag.pT(),     event.weight() ); //(6,1,1);
	_h_NrmPtclDiffXsecTjY->fill(  noBtag.absrap(), event.weight() ); //(6,1,3);
	...
	_h_AbsPtclDiffXsecTbarjPt->fill( noBtag.pT(),     event.weight() ); //(5,1,2);
	_h_AbsPtclDiffXsecTbarjY->fill(  noBtag.absrap(), event.weight() ); //(5,1,4);
	_h_NrmPtclDiffXsecTbarjPt->fill( noBtag.pT(),     event.weight() ); //(6,1,2);
	_h_NrmPtclDiffXsecTbarjY->fill(  noBtag.absrap(), event.weight() ); //(6,1,4);
    ...
    void finalize() {
      ...
      scale( _h_AbsPtclDiffXsecTPt, crossSection()/femtobarn/sumOfWeights() );
      scale( _h_AbsPtclDiffXsecTY,  crossSection() / sumOfWeights() );
      scale( _h_NrmPtclDiffXsecTPt, nrm / _c_Xsec_fid_tbarq->val() );
      scale( _h_NrmPtclDiffXsecTY,  nrm / _c_Xsec_fid_tbarq->val() );
