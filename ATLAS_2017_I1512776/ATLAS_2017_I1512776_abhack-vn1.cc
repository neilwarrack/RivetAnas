...
namespace Rivet {
  ...
  public:
    ...
    void init() {
      ...
      // Jets
      VetoedFinalState jet_input;
      jet_input.addVetoOnThisFinalState(DressedLeptons(PromptFinalState(Cuts::abseta < 2.6), 0.1, Cuts::abseta < 2.5 && Cuts::pT > 25*GeV));
	...
	MSG_DEBUG("  Passed parton selection");
