...
namespace Rivet {
  ...
  class RivetMC_tchan_particle : public Analysis {
  public:
    ...
    /// Constructor
    RivetMC_tchan_particle()
      : Analysis("RivetMC_tchan_particle")
    {
...
//    std::string cutnames[9];
  ...
  AnalysisBuilder<RivetMC_tchan_particle> plugin_RivetMC_tchan_particle;
