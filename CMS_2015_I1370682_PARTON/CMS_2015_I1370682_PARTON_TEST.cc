...
namespace Rivet {
  ...
  class CMS_2015_I1370682_PARTON_TEST : public Analysis {
  public:

    DEFAULT_RIVET_ANALYSIS_CTOR(CMS_2015_I1370682_PARTON_TEST);
	...
	cout << "______________________done!___" << endl;
      }
  ...
  DECLARE_RIVET_PLUGIN(CMS_2015_I1370682_PARTON_TEST);
